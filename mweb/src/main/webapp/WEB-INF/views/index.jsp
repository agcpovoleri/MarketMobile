					...
					<div class="row">
						...
						<div class="col-md-9 col-sm-8 col-xs-12 main-content">
							<header class="content-title">
								...
								<p class="title-desc">Save your money and time with our
									store. Here's the best part of our impressive assortment.</p>
							</header>
										...
										<div class="item item-hover">
											<div class="item-image-wrapper">
												<figure class="item-image-container">
													<a href="${ctx}/product/1"> <img
														src="${ctx}/static/images/products/item5.jpg" alt="item1"
														class="item-image"> <img
														src="${ctx}/static/images/products/item5-hover.jpg"
											...
											<div class="item-meta-container">
												...
												<h3 class="item-name">
													<a href="${ctx}/product/1">Phasellus consequat</a>
												</h3>
									...
									<div class="col-md-4 col-sm-6 col-xs-12">
										<div class="item item-hover">
											<div class="item-image-wrapper">
												<figure class="item-image-container">
													<a href="${ctx}/product/1"> <img
														src="${ctx}/static/images/products/item6.jpg" alt="item1"
														class="item-image"> <img
														src="${ctx}/static/images/products/item6-hover.jpg"
														alt="item1  Hover" class="item-image-hover">
													</a>
												</figure>
												<div class="item-price-container">
									...
									<div class="col-md-4 col-sm-6 col-xs-12">
										<div class="item item-hover">
											<div class="item-image-wrapper">
												<figure class="item-image-container">
													<a href="${ctx}/product/1"> <img
														src="${ctx}/static/images/products/item7.jpg" alt="item1"
														class="item-image"> <img
														src="${ctx}/static/images/products/item7-hover.jpg"
														alt="item1  Hover" class="item-image-hover">
													</a>
												</figure>
												<div class="item-price-container">
									...
									<div class="col-md-4 col-sm-6 col-xs-12">
										<div class="item item-hover">
											<div class="item-image-wrapper">
												<figure class="item-image-container">
													<a href="${ctx}/product/1"> <img
														src="${ctx}/static/images/products/item10.jpg"
														alt="item1" class="item-image"> <img
														src="${ctx}/static/images/products/item10-hover.jpg"
														alt="item1  Hover" class="item-image-hover">
													</a>
												</figure>
												<div class="item-price-container">
									...
									<div class="col-md-4 col-sm-6 col-xs-12">
										<div class="item item-hover">
											<div class="item-image-wrapper">
												<figure class="item-image-container">
													<a href="${ctx}/product/1"> <img
														src="${ctx}/static/images/products/item8.jpg" alt="item1"
														class="item-image"> <img
														src="${ctx}/static/images/products/item8-hover.jpg"
														alt="item1  Hover" class="item-image-hover">
													</a>
												</figure>
												<div class="item-price-container">
									...
									<div class="col-md-4 col-sm-6 col-xs-12">
										<div class="item item-hover">
											<div class="item-image-wrapper">
												<figure class="item-image-container">
													<a href="${ctx}/product/1"> <img
														src="${ctx}/static/images/products/item9.jpg" alt="item1"
														class="item-image"> <img
														src="${ctx}/static/images/products/item9-hover.jpg"
														alt="item1  Hover" class="item-image-hover">
													</a>
												</figure>
												<div class="item-price-container">
									...
									<div class="col-md-4 col-sm-6 col-xs-12">
										<div class="item item-hover">
											<div class="item-image-wrapper">
												<figure class="item-image-container">
													<a href="${ctx}/product/1"> <img
														src="${ctx}/static/images/products/item2.jpg" alt="item1"
														class="item-image"> <img
														src="${ctx}/static/images/products/item2-hover.jpg"
														alt="item1  Hover" class="item-image-hover">
													</a>
												</figure>
												<div class="item-price-container">
									...
									<div class="col-md-4 col-sm-6 col-xs-12">
										<div class="item item-hover">
											<div class="item-image-wrapper">
												<figure class="item-image-container">
													<a href="${ctx}/product/1"> <img
														src="${ctx}/static/images/products/item3.jpg" alt="item1"
														class="item-image"> <img
														src="${ctx}/static/images/products/item3-hover.jpg"
														alt="item1  Hover" class="item-image-hover">
													</a>
												</figure>
												<div class="item-price-container">
									...
									<div class="col-md-4 col-sm-6 col-xs-12">
										<div class="item item-hover">
											<div class="item-image-wrapper">
												<figure class="item-image-container">
													<a href="${ctx}/product/1"> <img
														src="${ctx}/static/images/products/item1.jpg" alt="item1"
														class="item-image"> <img
														src="${ctx}/static/images/products/item1-hover.jpg"
														alt="item1  Hover" class="item-image-hover">
													</a>
												</figure>
												<div class="item-price-container">
									...
									<div class="col-md-4 col-sm-6 col-xs-12">
										<div class="item item-hover">
											<div class="item-image-wrapper">
												<figure class="item-image-container">
													<a href="${ctx}/product/1"> <img
														src="${ctx}/static/images/products/item4.jpg" alt="item1"
														class="item-image"> <img
														src="${ctx}/static/images/products/item4-hover.jpg"
														alt="item1  Hover" class="item-image-hover">
													</a>
												</figure>
												<div class="item-price-container">
							...
							<div class="row">
								<div class="col-md-7 col-sm-7 col-xs-12">
									...
									<p>
										&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Venedor is a fully responsive
										Magento theme with advanced admin module. Based on Bootstrap’s
										12 column 1200px responsive grid Theme. Great looks on
										desktops, tablets and mobiles. <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Venedor
										is extremely customizable, easy to use and fully responsive.
										Suitable for every type of store. Great as a starting point
										for your custom projects. This theme includes several
										extensions including ajax price slider that will help you
										improve your sales. We supply a full help with our products
										and after purchase support to all our customers. <a href="#">Buy
											Venedor Theme!</a>
									</p>
								</div>
								<!-- End .col-md-7 -->
								<div class="col-md-5 col-sm-5 col-xs-12">
									...
									<!-- space -->
									<img src="${ctx}/static/images/showcase.png"
										alt="Showcase Venedor" class="img-responsive">
								</div>
								<!-- End .col-md-5 -->
							</div>
							<!-- End .row -->
						...
						<div class="col-md-3 col-sm-4 col-xs-12 sidebar">
							<div class="widget subscribe">
								...
								<p>Get all the latest information on Events, Sales and
									Offers. Sign up for the Venedor store newsletter today.</p>
									...
									<ul class="testimonials-list clearfix">
										<li>
											...
											<figure class="clearfix">
												<img src="${ctx}/static/images/testimonials/anna.jpg"
													alt="Computer Ceo">
												<figcaption>
													<a href="#">Anna Retallic</a> <span>12.05.2013</span>
												</figcaption>
											</figure>
										</li>
										<li>
											<div class="testimonial-details">
												...
												Sunt iure quisquam necessitatibus fugit! Nisi tempora
												reiciendis omnis error sapiente ipsam maiores dolorem
												maxime.
											</div>
											<!-- End .testimonial-details -->
											<figure class="clearfix">
												<img src="${ctx}/static/images/testimonials/jake.jpg"
													alt="Computer Ceo">
												<figcaption>
													<a href="#">Jake Suasoo</a> <span>17.05.2013</span>
												</figcaption>
											</figure>
										</li>
									</ul>
								...
								<div class="latest-posts-slider flexslider sidebarslider">
									<ul class="latest-posts-list clearfix">
										<li><a href="single.html">
												<figure class="latest-posts-media-container">
													<img class="img-responsive"
														src="${ctx}/static/images/blog/post1-small.jpg"
														alt="lats post">
												</figure>
										</a>
											<h4>
												<a href="single.html">35% Discount on second purchase!</a>
											</h4>
											<p>Sed blandit nulla nec nunc ullamcorper tristique.
												Mauris adipiscing cursus ante ultricies dictum sed lobortis.</p>
											...
											<!-- End .latest-posts-meta-container --></li>

										<li><a href="single.html">
												<figure class="latest-posts-media-container">
													<img class="img-responsive"
														src="${ctx}/static/images/blog/post2-small.jpg"
														alt="lats post">
												</figure>
										</a>
											<h4>
												<a href="single.html">Free shipping for regular
													customers.</a>
											</h4>
											<p>Lorem ipsum dolor sit amet, consectetur adipisicing
												elit. Doloremque fuga officia in molestiae easint..</p>
											<div class="latest-posts-meta-container clearfix">
												<div class="pull-left">
													<a href="#">Read More...</a>
												</div>
										...
										<li><a href="single.html">
												<figure class="latest-posts-media-container">
													<img class="img-responsive"
														src="${ctx}/static/images/blog/post3-small.jpg"
														alt="lats post">
												</figure>
										</a>
											<h4>
												<a href="#">New jeans on sales!</a>
											</h4>
											<p>Lorem ipsum dolor sit amet, consectetur adipisicing
												elit. Doloremque fuga officia in molestiae easint..</p>
											<div class="latest-posts-meta-container clearfix">
							...
							<div class="widget banner-slider-container">
								<div class="banner-slider flexslider">
									<ul class="banner-slider-list clearfix">
										<li><a href="#"><img
												src="${ctx}/static/images/banner1.jpg" alt="Banner 1"></a></li>
										<li><a href="#"><img
												src="${ctx}/static/images/banner2.jpg" alt="Banner 2"></a></li>
										<li><a href="#"><img
												src="${ctx}/static/images/banner3.jpg" alt="Banner 3"></a></li>
									</ul>
								</div>
							</div>
							<!-- End .widget -->
					...
					<div id="brand-slider-container" class="carousel-wrapper">
						...
						<div class="row">
							<div class="brand-slider owl-carousel">
								<a href="#"><img
									src="${ctx}/static/images/brands/brand-logo.png"
									alt="Brand Logo 1"></a> <a href="#"><img
									src="${ctx}/static/images/brands/brand-logo.png"
									alt="Brand Logo 2"></a> <a href="#"><img
									src="${ctx}/static/images/brands/brand-logo.png"
									alt="Brand Logo 3"></a> <a href="#"><img
									src="${ctx}/static/images/brands/brand-logo.png"
									alt="Brand Logo 4"></a> <a href="#"><img
									src="${ctx}/static/images/brands/brand-logo.png"
									alt="Brand Logo 5"></a> <a href="#"><img
									src="${ctx}/static/images/brands/brand-logo.png"
									alt="Brand Logo 6"></a> <a href="#"><img
									src="${ctx}/static/images/brands/brand-logo.png"
									alt="Brand Logo 7"></a> <a href="#"><img
									src="${ctx}/static/images/brands/brand-logo.png"
									alt="Brand Logo 8"></a> <a href="#"><img
									src="${ctx}/static/images/brands/brand-logo.png"
									alt="Brand Logo 9"></a> <a href="#"><img
									src="${ctx}/static/images/brands/brand-logo.png"
									alt="Brand Logo 10"></a> <a href="#"><img
									src="${ctx}/static/images/brands/brand-logo.png"
									alt="Brand Logo 11"></a> <a href="#"><img
									src="${ctx}/static/images/brands/brand-logo.png"
									alt="Brand Logo 12"></a> <a href="#"><img
									src="${ctx}/static/images/brands/brand-logo.png"
									alt="Brand Logo 13"></a> <a href="#"><img
									src="${ctx}/static/images/brands/brand-logo.png"
									alt="Brand Logo 14"></a> <a href="#"><img
									src="${ctx}/static/images/brands/brand-logo.png"
									alt="Brand Logo 15"></a>
							</div>
							<!-- End .brand-slider -->
