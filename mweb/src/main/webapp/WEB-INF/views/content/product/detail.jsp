        				...
        				<div class="col-md-6 col-sm-12 col-xs-12 product-viewer clearfix">
        					...
        					<div id="product-image-carousel-container">
        						<ul id="product-carousel" class="celastislide-list">
	        						<li class="active-slide"><a data-rel='prettyPhoto[product]' href="images/products/big-item1.jpg" data-image="images/products/big-item1.jpg" data-zoom-image="images/products/big-item1.jpg" class="product-gallery-item"><img src="${ctx}/static/images/products/thumbnails/item10.jpg" alt="Phone photo 1"></a></li>
	        						<li><a data-rel='prettyPhoto[product]' href="images/products/big-item2.jpg" data-image="images/products/big-item2.jpg" data-zoom-image="images/products/big-item2.jpg" class="product-gallery-item"><img src="${ctx}/static/images/products/thumbnails/item11.jpg" alt="Phone photo 2"></a></li>
	        						<li><a data-rel='prettyPhoto[product]' href="images/products/big-item3.jpg" data-image="images/products/big-item3.jpg" data-zoom-image="images/products/big-item3.jpg" class="product-gallery-item"><img src="${ctx}/static/images/products/thumbnails/item12.jpg" alt="Phone photo 3"></a></li>
	        						<li><a data-rel='prettyPhoto[product]' href="images/products/big-item4.jpg" data-image="images/products/big-item4.jpg" data-zoom-image="images/products/big-item4.jpg" class="product-gallery-item"><img src="${ctx}/static/images/products/thumbnails/item13.jpg" alt="Phone photo 4"></a></li>
	        						<li><a data-rel='prettyPhoto[product]' href="images/products/big-item5.jpg" data-image="images/products/big-item5.jpg" data-zoom-image="images/products/big-item5.jpg" class="product-gallery-item"><img src="${ctx}/static/images/products/thumbnails/item14.jpg" alt="Phone photo 4"></a></li>

        					</ul><!-- End product-carousel -->
        					</div>

        					<div id="product-image-container">
        						<figure><img src="${ctx}/static/images/products/big-item1.jpg" data-zoom-image="images/products/big-item1.jpg" alt="Product Big image" id="product-image">
        								...
        								<ul class="related-list clearfix">
        									<li>
        										<div class="related-product clearfix">
        											<figure>
        												<img src="${ctx}/static/images/products/thumbnails/item1.jpg" alt="item1">
        											</figure>
        										...
        										<div class="related-product clearfix">
        											<figure>
        												<img src="${ctx}/static/images/products/thumbnails/item2.jpg" alt="item2">
        											</figure>
        										...
        										<div class="related-product clearfix">
        											<figure>
        												<img src="${ctx}/static/images/products/thumbnails/item3.jpg" alt="item3">
        											</figure>
        									...
        									<li>
        										<div class="related-product clearfix">
        											<figure>
        												<img src="${ctx}/static/images/products/thumbnails/item4.jpg" alt="item4">
        											</figure>
        										...
        										<div class="related-product clearfix">
        											<figure>
        												<img src="${ctx}/static/images/products/thumbnails/item5.jpg" alt="item5">
        											</figure>
        										...
        										<div class="related-product clearfix">
        											<figure>
        												<img src="${ctx}/static/images/products/thumbnails/item6.jpg" alt="item6">
        											</figure>
                                ...
                                <div class="purchased-items-slider owl-carousel">
                                    <div class="item item-hover">
                                        <div class="item-image-wrapper">
                                            <figure class="item-image-container">
                                                <a href="product.html">
                                                    <img src="${ctx}/static/images/products/item7.jpg" alt="item1" class="item-image">
                                                    <img src="${ctx}/static/images/products/item7-hover.jpg" alt="item1  Hover" class="item-image-hover">
                                                </a>
                                            </figure>
                                    ...
                                    <div class="item item-hover">
                                        <div class="item-image-wrapper">
                                            <figure class="item-image-container">
                                                <a href="product.html">
                                                    <img src="${ctx}/static/images/products/item8.jpg" alt="item1" class="item-image">
                                                    <img src="${ctx}/static/images/products/item8-hover.jpg" alt="item1  Hover" class="item-image-hover">
                                                </a>
                                            </figure>
                                            <div class="item-price-container">
                                    ...
                                    <div class="item item-hover">
                                        <div class="item-image-wrapper">
                                            <figure class="item-image-container">
                                                <a href="product.html">
                                                    <img src="${ctx}/static/images/products/item9.jpg" alt="item1" class="item-image">
                                                    <img src="${ctx}/static/images/products/item9-hover.jpg" alt="item1  Hover" class="item-image-hover">
                                                </a>
                                            </figure>
                                            <div class="item-price-container">
                                    ...
                                    <div class="item item-hover">
                                        <div class="item-image-wrapper">
                                            <figure class="item-image-container">
                                                <a href="product.html">
                                                    <img src="${ctx}/static/images/products/item6.jpg" alt="item1" class="item-image">
                                                    <img src="${ctx}/static/images/products/item6-hover.jpg" alt="item1  Hover" class="item-image-hover">
                                                </a>
                                            </figure>
                                            <div class="item-price-container">
                                    ...
                                    <div class="item item-hover">
                                        <div class="item-image-wrapper">
                                            <figure class="item-image-container">
                                                <a href="product.html">
                                                    <img src="${ctx}/static/images/products/item10.jpg" alt="item1" class="item-image">
                                                    <img src="${ctx}/static/images/products/item10-hover.jpg" alt="item1  Hover" class="item-image-hover">
                                                </a>
                                            </figure>
                                            <div class="item-price-container">
