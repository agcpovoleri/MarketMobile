        				...
        				<div class="row">
        					...
        					<div class="col-md-9 col-sm-8 col-xs-12 main-content">
        						...
        						<div id="category-header" class="category-banner">
        							<img src="${ctx}/static/images/banner.png" alt="Category banner" class="img-responsive">
                                        ...
                                        <div class="item item-hover">
                                            <div class="item-image-wrapper">
                                                <figure class="item-image-container">
                                                    <a href="product.html">
                                                        <img src="${ctx}/static/images/products/item2.jpg" alt="item1" class="item-image">
                                                        <img src="${ctx}/static/images/products/item2-hover.jpg" alt="item1  Hover" class="item-image-hover">
                                                    </a>
                                                </figure>
                                    ...
                                    <div class="col-md-4 col-sm-6 col-xs-12">
                                        <div class="item item-hover">
                                            <div class="item-image-wrapper">
                                                <figure class="item-image-container">
                                                    <a href="product.html">
                                                        <img src="${ctx}/static/images/products/item1.jpg" alt="item1" class="item-image">
                                                        <img src="${ctx}/static/images/products/item1-hover.jpg" alt="item1  Hover" class="item-image-hover">
                                                    </a>
                                                </figure>
                                                <div class="item-price-container">
                                    ...
                                    <div class="col-md-4 col-sm-6 col-xs-12">
                                        <div class="item item-hover">
                                            <div class="item-image-wrapper">
                                                <figure class="item-image-container">
                                                    <a href="product.html">
                                                        <img src="${ctx}/static/images/products/item4.jpg" alt="item1" class="item-image">
                                                        <img src="${ctx}/static/images/products/item4-hover.jpg" alt="item1  Hover" class="item-image-hover">
                                                    </a>
                                                </figure>
                                                <div class="item-price-container">
                                    ...
                                    <div class="col-md-4 col-sm-6 col-xs-12">
                                        <div class="item item-hover">
                                            <div class="item-image-wrapper">
                                                <figure class="item-image-container">
                                                    <a href="product.html">
                                                        <img src="${ctx}/static/images/products/item3.jpg" alt="item1" class="item-image">
                                                        <img src="${ctx}/static/images/products/item3-hover.jpg" alt="item1  Hover" class="item-image-hover">
                                                    </a>
                                                </figure>
                                                <div class="item-price-container">
                                    ...
                                    <div class="col-md-4 col-sm-6 col-xs-12">
                                        <div class="item item-hover">
                                            <div class="item-image-wrapper">
                                                <figure class="item-image-container">
                                                    <a href="product.html">
                                                        <img src="${ctx}/static/images/products/item5.jpg" alt="item1" class="item-image">
                                                        <img src="${ctx}/static/images/products/item5-hover.jpg" alt="item1  Hover" class="item-image-hover">
                                                    </a>
                                                </figure>
                                                <div class="item-price-container">
                                                    <span class="old-price">$120<span class="sub-price">.99</span></span>
        							...
        							<div class="featured-slider flexslider sidebarslider">
        								<ul class="featured-list clearfix">
        									...
        									<li>
        										...
        										<div class="featured-product clearfix">
        											<figure>
        												<img src="${ctx}/static/images/products/thumbnails/item7.jpg" alt="item7">
        											</figure>
        						...
        						<div class="widget banner-slider-container">
        							<div class="banner-slider flexslider">
        								<ul class="banner-slider-list clearfix">
        									<li><a href="#"><img src="${ctx}/static/images/banner1.jpg" alt="Banner 1"></a></li>
        									<li><a href="#"><img src="${ctx}/static/images/banner2.jpg" alt="Banner 2"></a></li>
        									<li><a href="#"><img src="${ctx}/static/images/banner3.jpg" alt="Banner 3"></a></li>
        								</ul>
        							</div>
        						</div><!-- End .widget -->
