				...
				<div class="row">
					<div class="col-md-12">
						<header class="content-title">
							...
							<p class="title-desc">Just this week, you can use the free
								premium delivery.</p>
						</header>
									...
									<tbody>
										<tr>
											<td class="item-name-col">
												<figure>
													<a href="#"><img
														src="${ctx}/static/images/products/compare1.jpg"
														alt="Lowlands Lace Blouse"></a>
												</figure> <header class="item-name">
											...
											<td>
												<div class="custom-quantity-input">
													<input type="text" name="quantity" value="1"> <a
										...
										<tr>
											<td class="item-name-col">
												<figure>
													<a href="#"><img
														src="${ctx}/static/images/products/compare2.jpg"
														alt="Samsung Galaxy Ace"></a>
												</figure> <header class="item-name">
													<a href="#">Samsung Galaxy Ace</a>
												</header>
												<ul>
													<li>Color: Black</li>
													<li>Size: XL</li>
										...
										<tr>
											<td class="item-name-col">
												<figure>
													<a href="#"><img
														src="${ctx}/static/images/products/compare3.jpg"
														alt="Iphone Case Cover Original"></a>
												</figure> <header class="item-name">
											...
											<td class="item-code">MP125984154</td>
											<td class="item-price-col"><span
												class="item-price-special">$399</span></td>
											<td>
												<div class="custom-quantity-input">
													<input type="text" name="quantity" value="3"> <a
														href="#" onclick="return false;"
														class="quantity-btn quantity-input-up"><i
														class="fa fa-angle-up"></i></a> <a href="#"
														onclick="return false;"
											...
											<td class="item-total-col"><span
												class="item-price-special">$1197</span> <a href="#"
												class="close-button"></a></td>
										</tr>
									</tbody>
								</table>
						...
						<div class="row">
								...
								<div class="tab-container left clearfix">
									<ul class="nav-tabs">
										<li class="active"><a href="#shipping" data-toggle="tab">Shipping
												&amp; Taxes</a></li>
										<li><a href="#discount" data-toggle="tab">Discount
												Code</a></li>
									...
									<div class="tab-content clearfix">
										<div class="tab-pane active" id="shipping">
											...
											<form action="#" id="shipping-form">
												<p class="shipping-desc">Enter your destination to get a
													shipping estimate.</p>
										...
										<div class="tab-pane" id="gift">
											<p>Lorem ipsum dolor sit amet, consectetur adipisicing
												elit. Sequi dignissimos nostrum debitis optio molestiae in
												quam dicta labore obcaecati ullam necessitatibus animi
												deleniti minima dolor suscipit nobis est excepturi
												inventore.</p>
										</div>
										<!-- End .tab-pane -->
							...
							<div class="col-md-4 col-sm-12 col-xs-12">
								...
								<!-- End .space -->
								<a href="#" class="btn btn-custom-2">CONTINUE SHOPPING</a> <a
									href="#" class="btn btn-custom">CHECKOUT</a>
							</div>
							<!-- End .col-md-4 -->
						</div>
						<!-- End .row -->
						...
						<div class="similiar-items-container carousel-wrapper">
							<header class="content-title">
								...
								<!-- End .title-bg -->
								<p class="title-desc">Note the similar products - after
									buying for more than $500 you can get a discount.</p>
							</header>

							<div class="carousel-controls">
								<div id="similiar-items-slider-prev"
							...
							<div class="similiar-items-slider owl-carousel">
								...
								<div class="item item-hover">
									<div class="item-image-wrapper">
										<figure class="item-image-container">
											<a href="product.html"> <img
												src="${ctx}/static/images/products/item10.jpg" alt="item1"
												class="item-image"> <img
										...
										<div class="item-price-container">
											<span class="old-price">$120</span> <span class="item-price">$60</span>
										</div>
										<!-- End .item-price-container -->
