                                ...
                                <div class="team-member-header clearfix">
                                    <div class="row">
                                        <div class="col-md-4 col-sm-12 col-xs-12">
                                            <figure>
                                                <img src="${ctx}/static/images/team/bryant.jpg" alt="Dawe Bryant" class="img-responsive">
                                            </figure>
                                ...
                                <div class="team-member-content">
                                    <div class="row">
                                        <div class="col-md-3 col-sm-3 col-xs-6 team-member">
                                           <figure>
                                            <img src="${ctx}/static/images/team/courtney.jpg" alt="Courtney Bryant">
                                           </figure>
                                           <div class="team-member-name">Courtney Bryant</div><!-- End .team-member-name -->
                                        ...
                                        <div class="col-md-3 col-sm-3 col-xs-6 team-member">
                                           <figure>
                                            <img src="${ctx}/static/images/team/walter.jpg" alt="Walter Allter">
                                           </figure>
                                        ...
                                        <div class="col-md-3 col-sm-3 col-xs-6 team-member">
                                           <figure>
                                            <img src="${ctx}/static/images/team/arron.jpg" alt="Arron Rivera">
                                           </figure>
                                        ...
                                        <div class="col-md-3 col-sm-3 col-xs-6 team-member">
                                           <figure>
                                            <img src="${ctx}/static/images/team/evan.jpg" alt="Evan Brooks">
                                           </figure>
                                        ...
                                        <div class="col-md-3 col-sm-3 col-xs-6 team-member">
                                           <figure>
                                            <img src="${ctx}/static/images/team/susan.jpg" alt="Susan Brooks">
                                           </figure>
                                        ...
                                        <div class="col-md-3 col-sm-3 col-xs-6 team-member">
                                           <figure>
                                            <img src="${ctx}/static/images/team/jake.jpg" alt="Jake Bryant">
                                           </figure>
                                        ...
                                        <div class="col-md-3 col-sm-3 col-xs-6 team-member">
                                           <figure>
                                            <img src="${ctx}/static/images/team/jane.jpg" alt="Jane Bryant">
                                           </figure>
                                        ...
                                        <div class="col-md-3 col-sm-3 col-xs-6 team-member">
                                           <figure>
                                            <img src="${ctx}/static/images/team/diana.jpg" alt="Diana Rivera">
                                           </figure>
                            ...
                            <header class="content-title">
                                ...
                                <div class="row">
                                    <div class="brand-slider owl-carousel">
                                        <a href="#"><img src="${ctx}/static/images/brands/brand-logo.png" alt="Brand Logo 1"></a>
                                        <a href="#"><img src="${ctx}/static/images/brands/brand-logo.png" alt="Brand Logo 2"></a>
                                        <a href="#"><img src="${ctx}/static/images/brands/brand-logo.png" alt="Brand Logo 3"></a>
                                        <a href="#"><img src="${ctx}/static/images/brands/brand-logo.png" alt="Brand Logo 4"></a>
                                        <a href="#"><img src="${ctx}/static/images/brands/brand-logo.png" alt="Brand Logo 5"></a>
                                        <a href="#"><img src="${ctx}/static/images/brands/brand-logo.png" alt="Brand Logo 6"></a>
                                        <a href="#"><img src="${ctx}/static/images/brands/brand-logo.png" alt="Brand Logo 7"></a>
                                        <a href="#"><img src="${ctx}/static/images/brands/brand-logo.png" alt="Brand Logo 8"></a>
                                        <a href="#"><img src="${ctx}/static/images/brands/brand-logo.png" alt="Brand Logo 9"></a>
                                        <a href="#"><img src="${ctx}/static/images/brands/brand-logo.png" alt="Brand Logo 10"></a>
                                        <a href="#"><img src="${ctx}/static/images/brands/brand-logo.png" alt="Brand Logo 11"></a>
                                        <a href="#"><img src="${ctx}/static/images/brands/brand-logo.png" alt="Brand Logo 12"></a>
                                        <a href="#"><img src="${ctx}/static/images/brands/brand-logo.png" alt="Brand Logo 13"></a>
                                        <a href="#"><img src="${ctx}/static/images/brands/brand-logo.png" alt="Brand Logo 14"></a>
                                        <a href="#"><img src="${ctx}/static/images/brands/brand-logo.png" alt="Brand Logo 15"></a>
