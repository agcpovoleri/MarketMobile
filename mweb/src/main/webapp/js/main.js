	...
	var Venedor = {
		...
		stickyMenu: function () {
	        ...
	        if (windowTop >= navDist && windowTop > headerHeight && windowWidth > 768) {
	        	...
	        	//	console.log(windowTop+" >= "+navDist +" && "+windowTop + " > "+ headerHeight + " && "+ windowWidth + "> 768 = "+(windowTop > headerHeight && windowWidth > 768));
				//console.log(!navContainer.closest('.fixed-wrapper').length);
				console.log(navContainer.closest('.fixed-wrapper').length);
...
(function () {
    ...
    function initialize() {
        ...
        var map = new google.maps.Map(document.getElementById("map"), mappy),
        	newpin = '${ctx}/static/images/pin.png';
